...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{IMX230_SENSOR_ID, 0xA0, CMD_CAT24C16, cam_cal_check_mtk_cid},
	{S5K3P3SX_SENSOR_ID, 0xA2, CMD_GT24C32A, cam_cal_check_mtk_cid},
	{S5K3P3SQ_SENSOR_ID, 0xA2, CMD_GT24C32A, cam_cal_check_mtk_cid},
