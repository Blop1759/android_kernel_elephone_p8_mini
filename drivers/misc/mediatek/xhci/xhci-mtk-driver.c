...
/* Vanzo:zhangqingzhan on: Wed, 26 Oct 2016 11:28:35 +0800
 * for tusb302 otg detect
 */
...
/* Vanzo:zhangqingzhan on: Tue, 03 Jan 2017 23:08:59 +0800
 * for typc c otg
 */
static int mtk_iddig_gpionum;
// End of Vanzo: zhangqingzhan
...
/* Vanzo:zhangqingzhan on: Wed, 26 Oct 2016 11:29:12 +0800
 *for tusb302 otg detect
 */
static bool mtk_get_gpio_otg_statue(void)
{
	int vol = __gpio_get_value(mtk_iddig_gpionum);

	mtk_xhci_mtk_printk(K_DEBUG, "iddig(%d)\n", vol);

#if defined(CONFIG_USBIF_COMPLIANCE) || defined(CONFIG_POWER_EXT)
	return false;
#else
	return (vol > 0) ? true : false;
#endif
}
// End of Vanzo: zhangqingzhan
/* Vanzo:zhangqingzhan on: Tue, 03 Jan 2017 22:55:33 +0800
 * for type c otg
...
/* Vanzo:zhangqingzhan on: Tue, 03 Jan 2017 22:54:05 +0800
 * for ncp1854 otg
 */
...
#if defined(CONFIG_MTK_BQ25898_DUAL_SUPPORT)
	bq25898_otg_en(0x0);
/* Vanzo:zhangqingzhan on: Tue, 03 Jan 2017 22:54:49 +0800
 * for ncp charge
 */
#elif defined(CONFIG_MTK_NCP1854_SUPPORT)
...
/* Vanzo:zhangqingzhan on: Wed, 26 Oct 2016 11:29:53 +0800
 *for tusb302 otg detect
		mtk_idpin_cur_stat = (mtk_is_charger_4_vol()) ? IDPIN_IN_DEVICE : IDPIN_IN_HOST;
 */
		mtk_idpin_cur_stat = (mtk_get_gpio_otg_statue()) ? IDPIN_IN_DEVICE : IDPIN_IN_HOST;
// End of Vanzo: zhangqingzhan
...
/* Vanzo:zhangqingzhan on: Tue, 03 Jan 2017 23:10:05 +0800
 * for Type c otg
...
// End of Vanzo: zhangqingzhan
	...
	if (node) {
		...
		if (node) {
			...
			if (!retval) {
/* Vanzo:zhangqingzhan on: Tue, 03 Jan 2017 23:09:23 +0800
 * for type c otg
				iddig_gpio = ints[0];
 */
				mtk_iddig_gpionum = ints[0];
// End of Vanzo: zhangqingzhan
